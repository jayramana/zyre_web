...
const Terms = () => {
  ...
  return (
    <div className="h-screen bg-black overflow-y-scroll fixed text-white p-[4rem]">
      ...
      <div className="py-[1rem]">
        ...
        <ul className="flex flex-col gap-[.5rem]">
          <li>
            <p className="text-[#ffffff99]">
              <strong className="text-white">Affiliate</strong> means an entity
          ...
          <li>
            <p className="text-[#ffffff99]">
              ...
              &quot;Our&quot; in this Agreement) refers to zyre .
            </p>
          </li>
          <li>
            <p className="text-[#ffffff99]">
          ...
          <li>
            <p className="text-[#ffffff99]">
              <strong className="text-white">Terms and Conditions</strong> (also
      ...
      <p className="text-[#ffffff99]">
        ...
        each {apos.partys} liability will be limited to the greatest extent
        permitted by law.
      </p>
      ...
      <ul className="flex justify-between">
        ...
        <li>
          <p>
            ...
            <a href="zyre.com" rel="external nofollow noopener" target="_blank">
